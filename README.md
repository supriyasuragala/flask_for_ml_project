# Flask for Machine Learning Project

## Overview

This repository contains the materials and code, which focuses on deploying machine learning models using Flask.We developed a project to predict flight prices.Covered interpreting learning curves, evaluating and selecting models, creating a web application with Flask, and deploying the app using Render.
